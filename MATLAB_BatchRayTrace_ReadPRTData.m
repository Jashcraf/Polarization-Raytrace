function [ xData,yData,zData,lData,mData,nData,l2Data,m2Data,n2Data,n1,n2 ] = MATLAB_BatchRayTrace_ReadPRTData( surface, nrays, hx, hy, filename )
...
if isempty(TheApplication)
    ...
    try
        [ xData,yData,zData,lData,mData,nData,l2Data,m2Data,n2Data,n1,n2 ] = BeginApplication(TheApplication, surface, nrays, hx, hy, filename);
...
function [ xData,yData,zData,lData,mData,nData,l2Data,m2Data,n2Data,n1,n2 ] = BeginApplication(TheApplication, surface, nrays, hx, hy, filename)
